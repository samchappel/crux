...
Revision ID: 86815d6b1841
Revises: 
Create Date: 2023-03-29 18:59:05.671558
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['climber_id'], ['climbers.id'], name=op.f('fk_ticks_climber_id_climbers')),
    sa.ForeignKeyConstraint(['route_id'], ['routes.id'], name=op.f('fk_ticks_route_id_routes')),
    sa.PrimaryKeyConstraint('id')
    )
